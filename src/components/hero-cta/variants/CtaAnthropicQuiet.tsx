...
/** 1 — Anthropic: quiet sentence case + plug icon. */
export function CtaAnthropicQuiet() {
  return (
    <Link
      href={HERO_CTA_HREF}
      className={cn(
        base,
        "h-12 bg-charcoal px-8 text-base font-normal tracking-[-0.01em] text-cream hover:bg-charcoal/90"
      )}
    >
