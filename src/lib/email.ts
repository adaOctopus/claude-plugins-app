...
function emailBrandWordmarkHtml(heightPx = 30) {
  ...
  return `<img src="${wordmarkUrl}" alt="coolplugz" height="${heightPx}" style="display: inline-block; vertical-align: middle; margin-top: 4px; border: 0; height: ${heightPx}px; width: auto;" />`;
}
