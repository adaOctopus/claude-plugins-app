...
export default function TermsPage() {
  return (
    <LegalDocument title="Terms of Service">
      ...
      <LegalSection title="4. Subscriptions, Billing, and One Run">
        <p>
          Paid plans, One Run purchases, and add-ons are described on our pricing page. By
        ...
        <ul>
          ...
          <li>One Run is a one-time $5 charge for 1 task run and 24-hour access — no automatic renewal</li>
